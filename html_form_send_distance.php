...
if(isset($_POST['email'])) {
    ...
    $email_subject = "Important! Distance Learning Applicant";
   ...
   $first_name = $_POST['first_name']; // required
    ...
    $race = $_POST['race']; // not required
    $race_other = $_POST['race_other']; // not required
 ...
 $error_message .= 'The Area Code you entered does not appear to be valid.<br />';
  ...
  $email_message .= "Race if Selected Other: ".clean_string($race_other)."\n";
	$email_message .= "------------------------------------"."\r\n";
	...
	$email_message .= "Study Period: Distance Learning"."\n";
            ...
            <div class="content-wrap">
              <div class="container center clearfix">
                  <div class="heading-block center">
                      ...
                      <span>The R400 non-refundable application fee is payable to:</span>
                    </div>
                       <p>
                         <img src="images/bank_details1.png" alt="Bank Details">
                      </p>
                      <div class="col_half right">
                      <span style="font-size:1.2em;"> Please submit the proof of payment along with a copy of your highest academic qualification to <a href=mailto:admin@hccollege.co.za rel=external style=color:"#555">admin@hccollege.co.za.</a>
                        Once we have received it, HC Varsity will contact you.
                      </span>
                    </div>
